...
btn_step_two.onclick = function () {
    typePype('print(response.json()["web_development_experience"])', document.getElementById('step_two_text'), document.getElementById('step_two_restext'), '{<br><p class="text_indent">"backend python frameworks": ["advanced Django", "intermediate Django Rest Framework", "basic Flask"],</p><p class="text_indent">"Go backend": ["pure basic", "gorilla", "chi", "fizz"],</p><p class="text_indent">"frontend frameworks": ["Vue basic"],</p><p class="text_indent">"HTML": ["full advanced"],</p><p class="text_indent">"CSS": ["pure advanced", "SCSS basic", "bootstrap5"],</p><p class="text_indent">"JS": ["pure intermediate"],</p><p class="text_indent">"Php": ["pure basic", "1c-bitrix basic"],</p><p class="text_indent">"Kid`s constructors": ["Tilda", "WordPress(Elementor, etc.)"],</p><p class="text_indent">"Deployment experience": ["Docker advanced", "Kubernetes basic", "etc."],</p>}', 500, 0.1, btn_step_three);
