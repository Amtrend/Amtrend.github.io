...
typePype('import requests\n\nAPI_URL = "◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼◼"\n\nresponse = requests.get(API_URL)\nprint(response.json()["python_knowledge"])', document.getElementById('step_one_text'), document.getElementById('step_one_restext'), '{<br><p class="text_indent">"language": ["advanced",],</p><p class="text_indent">"frameworks": ["advanced Django", "basic Django Rest Framework"],</p><p class="text_indent">"used_packages": ["requests", "pandas", "scapy", "smtplib", "imaplib", "tkinter", "BeautifulSoup4", "celery", "re", "selenium", "socket", "subprocess", "sys", "etc."],</p>}', 300, 2, btn_step_two);

btn_step_two.onclick = function () {
    typePype('print(response.json()["web_development_experience"])', document.getElementById('step_two_text'), document.getElementById('step_two_restext'), '{<br><p class="text_indent">"Constructors": ["Tilda", "WordPress(Elementor, etc.)"],</p><p class="text_indent">"HTML": ["full",],</p><p class="text_indent">"CSS": ["pure", "SCSS", "bootstrap5"],</p><p class="text_indent">"JS": ["pure basic",],</p><p class="text_indent">"Php": ["pure basic", "1c-bitrix basic"],</p><p class="text_indent">"Python": ["advanced Django", "basic Django Rest Framework", "basic Flask"],</p>}', 300, 2, btn_step_three);
